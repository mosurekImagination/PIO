...
/**
 * 	Klasa umożliwiająca wymianę danych z relacją "pozycjezamowienia" w bazie danych "hurtownia".
 */
public class PozycjaZamowieniaContext {
	...
	/**
	 * 	Metoda przesyłająca do bazy dane pozycji zamówienia.
	 */
	...
	/**
	 * Metoda pobierająca z bazy dane pozycji zamówienia.
	 */
