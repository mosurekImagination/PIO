...
/**
 * 	Klasa umożliwiająca wymianę danych z relacją "zapytanie" w bazie danych "hurtownia".
 */
class ZapytanieContext {
	...
	/**
	 * 	Metoda przesyłająca do bazy dane zapytania.
	 */
	...
	/**
	 * Metoda pobierająca z bazy dane zapytań.
	 */
	...
	/**
	 * Metoda zatwierdzająca zapytanie w bazie danych.
	 */
	 public Zapytanie zatwierdzZapytanie(Zapytanie zapytanie) {
	 	...
	 	/**
		 * Metoda odrzucająca zapytanie w bazie danych.
		 */
