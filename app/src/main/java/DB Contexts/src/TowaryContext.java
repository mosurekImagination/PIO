...
/**
 * 	Klasa umożliwiająca wymianę danych z relacją "towary" w bazie danych "hurtownia".
 */
public class TowaryContext {
	...
	/**
	 * Metoda pobierająca z bazy dane towarów.
	 */
	...
	/**
	 * Metoda aktualizująca w bazie danych ilość towarów.
	 */
