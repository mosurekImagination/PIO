...
CREATE TABLE PozycjaZamowienia (IdPZ int(10) NOT NULL AUTO_INCREMENT, Ilosc int(10) NOT NULL, Cena float NOT NULL, Rabat float NOT NULL, CenaPoRabacie float NOT NULL, ZapytanieIdZap int(10), TowarIdT int(10) NOT NULL, ZamówienieIdZ int(10) NOT NULL, PRIMARY KEY (IdPZ));
