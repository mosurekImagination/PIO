...
/**
 * 	Klasa umozliwiajaca wymiane danych z relacja "zapytanie" w bazie danych "hurtownia".
 */
class ZapytanieContext {
	...
	/**
	 * 	Metoda przesylajaca do bazy dane zapytania.
	 */
	...
	/**
	 * Metoda pobierajaca z bazy dane zapytan.
	 */
	...
	/**
	 * Metoda zatwierdzajaca zapytanie w bazie danych.
	 */
	 public Zapytanie zatwierdzZapytanie(Zapytanie zapytanie) {
	 	...
	 	/**
		 * Metoda odrzucajaca zapytanie w bazie danych.
		 */
